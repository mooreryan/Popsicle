...
(def regions {"ref1" [[2 5 "reg1"] [8 23 "reg2"] [0 0 "contig"]]})
...
(describe "region-stats"
          (it "returns a string with info about orfs"
              (should= ["ref1\treg1\t4\t3\t5\t2\t4.0\t0.816496580927726\t0.2041241452319315\t0.408248290463863\t0.25\t0.3333333333333333\n" 
                        "ref1\treg2\t16\t3\t9\t6\t6.0625\t1.691892431568863\t0.27907504025878155\t0.28198207192814384\t0.5625\t0.2666666666666667\n"] 
